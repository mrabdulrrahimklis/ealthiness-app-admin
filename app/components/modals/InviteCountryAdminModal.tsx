...
import { useInviteCountryAdmin } from "~/hooks/useAuthApi";

interface InviteCountryAdminModalProps {
  isOpen: boolean;
  onClose: () => void;
  countryId: string;
  countryName: string;
...
export const InviteCountryAdminModal: React.FC<InviteCountryAdminModalProps> = ({
  isOpen,
  onClose,
  countryId,
  countryName,
