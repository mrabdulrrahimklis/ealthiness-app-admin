...
import { useInviteRegionAdmin } from "~/hooks/useAuthApi";

interface InviteRegionAdminModalProps {
  isOpen: boolean;
  onClose: () => void;
  regionId: string;
  regionName: string;
...
export const InviteRegionAdminModal: React.FC<InviteRegionAdminModalProps> = ({
  isOpen,
  onClose,
  regionId,
  regionName,
  ...
  const inviteAdminMutation = useInviteRegionAdmin();
